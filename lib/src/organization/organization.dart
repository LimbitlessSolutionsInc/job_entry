...
import '../organization/emblems.dart';
...
enum Trainings{mill,lathe,tanks,thermoform,eye_wash,printer_3d,laser_safety,painting,horizontal_band_saw,vertical_band_saw,belt_sander,citi,injection_molding,sand_blasting,iso,hand_tools,soldering,auditor,auditor_trainer}
...
class Org{
  ...
  static Map<String, String>? getTrainingQuiz(Trainings? training){
    ...
    switch (training){
      ...
      case Trainings.hand_tools:
      case Trainings.soldering:
      case Trainings.eye_wash:
      case Trainings.auditor:
      case Trainings.auditor_trainer:
  ...
  static String? getTrainingDocumentId(Trainings? training){
    try{
      ...
      switch (training) {
        ...
        case Trainings.hand_tools:
          return '1VFwzoedC1xsVV2XXL9xUuaFhSgC_4_VWmg8oiLgL740';
        case Trainings.soldering:
          return '1VTPoMZbwEhC1RadCwH9youCzzWp1AUkTnubcSg_35UY';
        default:
          return null;
      }
    } catch(e){
