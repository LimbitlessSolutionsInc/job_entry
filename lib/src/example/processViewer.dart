...
//       addUser(router['details']['createdBy'],
//           displayName: 'Test User',
...
//               .firstWhere((e) => e.toString().split('.').last == j['status']),
//           good: j['good'],
//           bad: j['bad'],
...
//           order: (routerProcessData[key]['index'] == null)
//               ? index++
//               : routerProcessData[key]['index'],
//           processType: routerProcessData[key]['processType'] ?? 'Custom',
//         );
//       }
//     }
//     index = 0;
...
//           for (int i = 0;
//               i < routerJobData[key]['data']['workers'].length;
//               i++) {
...
//           for (int i = 0;
//               i < routerJobData[key]['data']['approvers'].length;
//               i++) {
...
//           workers: workers,
//           approvers: approvers,
//           notes: LSIFunctions.getFromData(
//               routerJobData[key]['data']['subTasks'], 'st_'),
...
//           Database.push('team', children: '$child/boards', data: {
...
//               children: '$child/boards/', location: id, data: data);
//         },
//         onCreateJob: (data) {
...
//               Messaging.sendPushMessage(sendTo, 'LSI Task Manager',
...
//               currentCards = (currentJobData[i]!.notes == null)
//                   ? 0
//                   : currentJobData[i]!.notes!.length;
//             }
//           }
...
//                   newWorkers.contains(data['workers'][i])) {
//                 uids.add(data['workers'][i]);
//               }
//             }
...
//           }
//           Database.update('team',
//               children: '$child/cards/$loc', location: 'data', data: data);
//         },
//         onJobDelete: (id) {
//           Database.update('team', children: '$child/cards/', location: id);
//         },
//         onProcessDelete: (id) {
//           Database.update(
//             'team',
...
//           Database.update('team',
//               children: '$child/boards/$id', location: 'title', data: title);
//         },
//         processData: null, //currentProcessData,
//         jobData: null, //currentJobData,
//         //order: currentProcessData['data']?.order ?? 0,
...
//     if (widget.router != oldBoardViewer.router ||
//         oldBoardViewer.width != widget.width ||
//         widget.color != oldBoardViewer.color ||
//         widget.completeData != oldBoardViewer.completeData) {
//       start();
//     } else if (update) {
//       setState(() {});
//     }
