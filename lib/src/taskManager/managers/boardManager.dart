...
class BoardManager extends StatefulWidget {
  ...
  final Function(Map<String, dynamic> data, String id, List<String> newAssigned)? onEditCard;
...
class _BoardManagerState extends State<BoardManager> {
  ...
  void start() {
    ...
    assignDropDown = LSIFunctions.setDropDownItems(widget.users);
    editorDropDown = LSIFunctions.setDropDownItems(widget.users);
    priDropDown = LSIFunctions.setDropDownItems([
  ...
  Future<void> cardSet(int i) async {
    await Future.delayed(const Duration(milliseconds: 250), (() {
      ...
      if (cardData[i].editors.isNotEmpty) {
        for (var element in cardData[i].editors) {
          editors.add(element);
        }
  ...
  void submitCardData() {
    ...
    if (widget.onCreateCard != null && isNewCard) {
      ...
      widget.onEditCard!(data, cardData[selectedCard!].id!, newAssigned);
    }
  }
          ...
          return Column(
              ...
              children: [
                Padding(
                    ...
                    child: Row(children: [
                      Text(
                        usersProfile[cardComments!['names']![i]]
                            ['displayName'],
                        style: TextStyle(
              ...
              children: [
                Padding(
                    ...
                    child: Row(
                      children: [
                        Text(
                          usersProfile[cardCheckList!['names']![i]]
                              ['displayName'],
                          style: TextStyle(
                              color: Theme.of(context)
                                  .primaryTextTheme
                                                        ...
                                                        if (isEditor()) {
                                                          ...
                                                          setState(() {
                                                            if (allowedAdd &&
                                                              ...
                                                              assigned.add(
                                                                  tempAssign);
                                                              if(!isNewCard){ newAssigned.add(tempAssign); }
                                                            }
                                                          });
                                                        }
                                                      },
