...
class _ProjectManagerState extends State<ProjectManager> {
  ...
  StreamSubscription<DatabaseEvent>? labelAdded;
  StreamSubscription<DatabaseEvent>? labelChanged;
  StreamSubscription<DatabaseEvent>? labelRemoved;
    ...
    try {
      ...
      labelRemoved = cardRef.onChildRemoved.listen((event) {
        setState(() {
          ...
          labelData = LSIFunctions.removeNull(labelData);
        });
      });
    } catch (e) {}
  }
    ...
    colorsWidget.add(FocusedInkWell(
      ...
      child: Container(
        ...
        child: Icon(Icons.color_lens,
            ...
            color: CSS.responsiveColor(projectClickedColor, 0.5)),
      ),
    ));
    return Wrap(
        //mainAxisAlignment: MainAxisAlignment.spaceAround,
