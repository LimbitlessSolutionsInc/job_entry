        ...
        Expanded(
          child: Scrollbar(
            ...
            child: ListView.separated(
              ...
              itemCount: 5, // hardcoded router amount for demo
              separatorBuilder: (_, __) => const SizedBox(height: 10),
              itemBuilder: (context, index) {
                return RouterCard(
                  title: 'Router #${index + 1}',
                  onTap: () {
                    debugPrint('Router tapped');
                  },
                );
              },
            ),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: css.darkGrey),
                  ),
                  child: TextFormField(
...
class _EditRouterFormWidgetState extends State<CreateRouterFormWidget> {
  final _formKey = GlobalKey<FormState>();
  String _newRouterName = '';
  int _newRouterColor = 0;
  bool _isArchived = false;
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        Navigator.of(context).pop(
                          RouterModel(
                            title: _newRouterName,
                            process: '', // process editing not implemented in this form
                            color: _newRouterColor,
                            isArchived: _isArchived,
                          ),
                        );
                      }
