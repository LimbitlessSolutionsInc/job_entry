...
// import 'package:flutter/material.dart';
// import 'package:job_entry/src/data/jobData.dart';
// import 'package:job_entry/src/data/routerData.dart';
// import 'package:job_entry/src/functions/lsi_functions.dart';
// import 'package:job_entry/src/managers/routerManager.dart';
// import 'package:job_entry/styles/savedWidgets.dart';
// import 'package:css/css.dart' as css;

// class ProcessManager extends StatefulWidget {
//   const ProcessManager({super.key, this.onRouterSelected});

//   final void Function(String)? onRouterSelected;
...
//       context: context,
//       builder: (context) => CreateJobFormWidget(),
//     );
//   }
...
// void _showJobDetails(BuildContext context, JobData job, RouterData router) {
...
//                         ],
//                       ),
//                       buildDetailRow('Job Name:', job.title ?? 'N/A'),
//                       buildDetailRow('Router Name:', router.title ?? 'N/A'),
//                       buildDetailRow('Created By:', job.createdBy),
//                       buildDetailRow('Date Created:', job.dateCreated),
//                       buildDetailRow('Due Date:', job.dueDate ?? 'N/A'),
//                       buildDetailRow('Start Date:', job.startDate ?? 'N/A'),
//                       buildDetailRow(
//                           'Complete Date:', job.completeDate ?? 'N/A'),
//                       buildDetailRow(
//                           'Status:', job.status.toString().split('.').last),
//                       buildDetailRow('Priority:', job.priority.toString()),
//                       buildDetailRow('Description:', job.description),
//                       buildDetailRow('Workers:', job.workers.join(', ')),
//                       buildDetailRow('Approvers:', job.approvers.join(', ')),
//                       buildDetailRow('Notes:', job.notes.toString()),
//                       buildDetailRow('Good:', job.good.toString()),
//                       buildDetailRow('Bad:', job.bad.toString()),
//                     ],
//                   ),
//                 ),
//               ])));
...
//   const CreateJobFormWidget({super.key});

//   @override
//   _CreateJobFormWidgetState createState() => _CreateJobFormWidgetState();
// }

// class openDatePicker {
//   @override
//   Widget build(BuildContext context) {
//     return Center(
//       child: Container(
...
//                           value: workers.contains(worker) ? null : worker,
//                           child: Text(worker),
//                         ))
//                     .toList(),
//                 onChanged: (value) {
//                   if (value != null && !workers.contains(value)) {
//                     setState(() {
//                       workers.add(value);
//                     });
//                   }
...
//                 decoration: const InputDecoration(
//                   border: OutlineInputBorder(),
//                   hintText: 'Enter any notes for this job',
//                   contentPadding:
//                       EdgeInsets.symmetric(horizontal: 12.0, vertical: 12.0),
//                 ),
//                 maxLines: 4,
...
//                   ),
//                   onPressed: () {
//                     debugPrint('Job Created: $jobName');
